...
public class AddToCart {
	...
	public void searchProductAndaddintoCart() throws InterruptedException {
		...
		//click on LED product
		/*try {
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//img[@id=\"det_img_4\"]")));
		...
		Thread.sleep(5000);
		 Actions actions1 = new Actions(driver);
	        WebElement elementLocator1 = driver.findElement(By.xpath("//span[@class='ty-minicart-title empty-cart ty-hand']"));
	        actions1.doubleClick(elementLocator1).perform();
		
		
		//click on View Product
		Thread.sleep(5000);
		driver.findElement(By.xpath("//div[@class=\"cm-cart-buttons ty-cart-content__buttons buttons-container full-cart\"]//a[@href='http://demo.cs-cart.com/stores/85b4f7148c889aa4/cart/']")).click();
